...
<frameset rows="64,*"  frameborder="NO" border="0" framespacing="0">
  ...
  <frameset cols="200,*"  rows="560,*" id="frame" border="1">
	<frame src="left.jsp" name="leftFrame" noresize="noresize" marginwidth="0" marginheight="0" frameborder="0"  target="main" scrolling="auto"/>
